import projectCandidatesHalfSizeImage from 'public/assets/Candidates-2_400x400.png';
import projectCandidatesFullSizeImage from 'public/assets/Candidates-2_800x400.png';
			...
			insights: [
				{
					...
					description:
						'Your “Top-3 Candidates” who have highest JavaScript knowledge are: Rachel Thompson, Tom Jackson, Samantha Kim',
				},
			],
			id: 22,
